...
class scan_dialog_appointment_fragment :DialogFragment() {
    override fun onCreateView(
        ...
        rootView.findViewById<Button>(R.id.addbtn).setOnClickListener {
            ...
            val makeScanFragment : Fragment = MakeScanAppointmentFragment()
        ...
        rootView.findViewById<Button>(R.id.viewbtn).setOnClickListener {
            ...
            val getScanFragment : Fragment = GetScanAppointmentFragment()
