...
class PatientScansAdapter(var items :List<GetPatientsScansByPatientIdResponseItem>?) : RecyclerView.Adapter<PatientScansAdapter.ViewHolder>() {
...
//        holder.lensImage.setImageResource(R.drawable.ic_lens)
    ...
    fun changeData(newItems:List<GetPatientsScansByPatientIdResponseItem>){
        items = newItems
    ...
    interface OnItemClickListener{
        fun onItemClick(pos:Int,item: GetPatientsScansByPatientIdResponseItem)
    }
}
