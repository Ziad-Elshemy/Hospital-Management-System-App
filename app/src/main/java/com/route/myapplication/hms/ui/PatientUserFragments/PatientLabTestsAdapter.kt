...
class PatientLabTestsAdapter(var items :List<GetPatientTestsByPatientIdResponseItem>?) : RecyclerView.Adapter<PatientLabTestsAdapter.ViewHolder>() {
...
//        holder.lensImage.setImageResource(R.drawable.ic_lens)
    ...
    fun changeData(newItems:List<GetPatientTestsByPatientIdResponseItem>){
        items = newItems
    ...
    interface OnItemClickListener{
        fun onItemClick(pos:Int,item: GetPatientTestsByPatientIdResponseItem)
    }
}
