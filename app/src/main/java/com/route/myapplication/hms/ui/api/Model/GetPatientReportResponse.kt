...
data class GetPatientReportResponse(
...
data class PrescriptionItemsItem_report(
...
data class ListOfMedicineNamesItem(
...
data class Result(
	...
	val listOfMedicineNames: List<ListOfMedicineNamesItem?>? = null,
	...
	val scanNames: List<String?>? = null,
...
data class Prescription_report(
	...
	val prescriptionItems: List<PrescriptionItemsItem_report?>? = null,
