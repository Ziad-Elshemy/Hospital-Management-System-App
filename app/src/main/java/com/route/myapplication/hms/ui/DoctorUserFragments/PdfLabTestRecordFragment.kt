...
class PdfLabTestRecordFragment : Fragment() {
//    var testsList: List<GetPatientTestByTestIdResponse> = arrayListOf()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val item: GetPatientTestByTestIdResponse = bundle!!.getSerializable("item") as GetPatientTestByTestIdResponse
    ...
    private fun getpatientById(patientId: Int,item: GetPatientTestByTestIdResponse) {
...
//    }
    ...
    private fun createPDF(item: GetPatientTestByTestIdResponse) {
        ...
        canvas.drawText("Patient:"+" " + patient?.firstName+" "+patient?.lastName, 390f, 190f, myPaint)

        canvas.drawText("Age:" +" "+ "43", 360f, 230f, myPaint)
