...
class DoctorAddPrescriptionAppointmentFragment : Fragment() {

    var doctor : GetDoctorByIdResponse = GetDoctorByIdResponse()
    lateinit var d_name : TextView
    lateinit var d_dept : TextView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        d_name = requireView().findViewById(R.id.d_name)
        d_dept = requireView().findViewById(R.id.d_dept)
    ...
    private fun getDoctorById(doctorID: Int) {
        ...
        ApiManager.getApis().getDoctorById(doctorID).enqueue(object : Callback<GetDoctorByIdResponse> {
            ...
            override fun onResponse(
                ...
                d_name.setText(doctor.firstName+" \n"+ doctor.lastName)
                d_dept.setText(doctor.docSpecialization)
            }
