...
class DoctorInpatientRecordAdapter (var items :List<GetIndoorPatientRecordByPatientIdResponseItem>?) : RecyclerView.Adapter<DoctorInpatientRecordAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return DoctorInpatientRecordAdapter.ViewHolder(view)
    }
